...
from .utils import formato_cop, formato_porcentaje, generar_pdf_unidades_funcionales_holding
...
def mostrar_unidades_funcionales():
    ...
    with col_boton:
        pdf_bytes = generar_pdf_unidades_funcionales_holding(
        ...
        st.download_button(
            label="📄 Exportar Informe Total de Unidades Funcionales del Holding a PDF",
            data=pdf_bytes,
