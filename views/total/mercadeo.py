...
import calendar
from .utils import formato_cop, formato_porcentaje, generar_pdf_mercadeo_holding
...
def mostrar_mercadeo():
    ...
    with col_boton:
        pdf_bytes = generar_pdf_mercadeo_holding(
        ...
        st.download_button(
            label="📄 Exportar Informe Ttoal de Mercadeo del Holding a PDF",
            data=pdf_bytes,
